...
public final class SizeOf {
    ...
    /**
     * magic ubyte[8] checksum uint signature ubyte[20] file_size uint
     * header_size uint endian_tag uint link_size uint link_off uint map_off
     * uint string_ids_size uint string_ids_off uint type_ids_size uint
     * type_ids_off uint proto_ids_size uint proto_ids_off uint field_ids_size
     * uint field_ids_off uint method_ids_size uint method_ids_off uint
     * class_defs_size uint class_defs_off uint data_size uint data_off uint
     */
    ...
    /**
     * class_idx uint access_flags uint superclass_idx uint interfaces_off uint
     * source_file_idx uint annotations_off uint class_data_off uint
