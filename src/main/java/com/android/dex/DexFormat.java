...
/**
 * Constants that show up in and are otherwise related to {@code .dex} files,
 * and helper methods for same.
 */
public final class DexFormat {
    ...
    /**
     * API level to target in order to pass through default and static interface
     * methods
     */
     ...
     * <p>
     * Note: Dex version 36 was loadable in some versions of Dalvik but was
     * never fully supported or completed and is not considered a valid dex file
     * format.
     * </p>
     */
    ...
    /**
     * file name of the primary {@code .dex} file inside an application or
     * library {@code .jar} file
     */
    ...
    /**
     * Maximum addressable field or method index. The largest addressable member
     * is 0xffff, in the "instruction formats" spec as field@CCCC or meth@CCCC.
     */
    public static final int MAX_MEMBER_IDX = 0xFFFF;

    /**
     * Maximum addressable type index. The largest addressable type is 0xffff,
     * in the "instruction formats" spec as type@CCCC.
     */
    public static final int MAX_TYPE_IDX = 0xFFFF;

    /**
     * Returns the API level corresponding to the given magic number, or
     * {@code -1} if the given array is not a well-formed dex file magic number.
     */
