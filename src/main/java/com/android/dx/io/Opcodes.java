...
public final class Opcodes {
     ...
     * special opcode values {@code
     * SPECIAL_FORMAT} and {@code NO_NEXT}. Note that not all of the opcode
     * values that pass this test are in fact used. This method is meant to
     * perform a quick check to reject blatantly wrong values (e.g. when
