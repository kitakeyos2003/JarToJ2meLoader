...
/**
 * A decoded Dalvik instruction. This consists of a format codec, a numeric
 ...
 * are consistently named alphabetically.</p>
 */
public abstract class DecodedInstruction {
     ...
     * constants (format 20bc) as well as should-be-zero values (formats 10x,
     * 20t, 30t, and 32x)
     */
     ...
     * each offset that represents the start of an instruction.
     */
