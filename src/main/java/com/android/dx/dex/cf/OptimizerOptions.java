...
public class OptimizerOptions {
    ...
    /**
     * {@code null-ok;} hash set of class name + method names that should be
     * optimized. {@code null} if this constraint was not specified on the
     * command line
     */
    private HashSet<String> optimizeList;

    /**
     * {@code null-ok;} hash set of class name + method names that should NOT be
     * optimized. null if this constraint was not specified on the command line
     */
