...
/**
 * Static method that turns {@code byte[]}s containing Java classfiles into
 * {@link ClassDefItem} instances.
 */
public class CfTranslator {
    ...
    /**
     * Takes a {@code byte[]}, interprets it as a Java classfile, and translates
     * it into a {@link ClassDefItem}.
     *
    ...
    /**
     * Performs the main act of translation. This method is separated from
     * {@link #translate} just to keep things a bit simpler in terms of
     * exception handling.
     *
     *
     * @param context {@code non-null;} the state global to this invocation.
    ...
    /**
     * Helper for {@link #processFields}, which translates constants into more
     * specific types if necessary.
     *
