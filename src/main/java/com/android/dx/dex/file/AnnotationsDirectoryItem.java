...
public final class AnnotationsDirectoryItem extends OffsettedItem {
     ...
     *
     * @return {@code true} if this item is empty, or {@code false} if not
     */
     ...
     * interning candidates are ones that <i>only</i> have a non-null set of
     * class annotations, with no other lists.
     *
     * @return {@code true} if this is an interning candidate, or {@code false}
     * if not
     */
     ...
     *
     * <p>
     * <b>Note:</b>: This throws an exception if this item is not
     * internable.</p>
     *
     * @see #isInternable
     */
    ...
    /**
     * Sets the direct annotations on this instance. These are annotations made
     * on the class, per se, as opposed to on one of its members. It is only
     * valid to call this method at most once per instance.
     *
     ...
     * This is meant to be called from {@link ClassDefItem#debugPrint}.
     *
