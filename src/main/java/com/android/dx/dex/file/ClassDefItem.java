...
/**
 * Representation of a Dalvik class, which is basically a set of members (fields
 * or methods) along with a few more pieces of information.
 */
public final class ClassDefItem extends IndexedItem {
    ...
    /**
     * {@code null-ok;} superclass or {@code null} if this class is a/the root
     * class
     */
    ...
    /**
     * {@code null-ok;} item wrapper for the static values, initialized in
     * {@link #addContents}
     */
    ...
    /**
     * Constructs an instance. Its sets of members and annotations are initially
     * empty.
     *
     * @param thisClass {@code non-null;} type constant for this class
     * @param accessFlags access flags
     * @param superclass {@code null-ok;} superclass or {@code null} if this
     * class is a/the root class
     * @param interfaces {@code non-null;} list of implemented interfaces
     * @param sourceFile {@code null-ok;} source file name or {@code null} if
     * unknown
     */
     ...
     * Gets the superclass.
     *
     * @return {@code null-ok;} the superclass or {@code null} if this class is
     * a/the root class
     */
    ...
    /**
     * Gets all the methods in this class. The returned list is not linked in
     * any way to the underlying lists contained in this instance, but the
     * objects contained in the list are shared.
     *
    ...
    /**
     * Sets the direct annotations on this class. These are annotations made on
     * the class, per se, as opposed to on one of its members. It is only valid
     * to call this method at most once per instance.
     *
    ...
    /**
     * Gets the method annotations for a given method, if any. This is meant for
     * use by debugging / dumping code.
     *
    ...
    /**
     * Gets the parameter annotations for a given method, if any. This is meant
     * for use by debugging / dumping code.
     *
     * @param method {@code non-null;} the method
