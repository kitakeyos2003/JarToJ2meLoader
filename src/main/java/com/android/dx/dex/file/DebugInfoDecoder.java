...
/**
 * A decoder for the dex debug info state machine format. This code exists
 * mostly as a reference implementation and test for for the
 * {@code DebugInfoEncoder}
 */
public class DebugInfoDecoder {
    ...
    /**
     * register size, in register units, of the register space used by this
     * method
     */
    ...
    /**
     * Gets the decoded locals list, in ascending start-address order. Valid
     * after calling {@code decode}.
     *
    ...
    /**
     * Reads a string index. String indicies are offset by 1, and a 0 value in
     * the stream (-1 as returned by this method) means "null"
     *
     ...
     * throwing an exception if they do not match. Used to validate the encoder.
     *
