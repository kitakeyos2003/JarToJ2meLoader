...
public abstract class MemberIdItem extends IdItem {
    ...
    /**
     * Returns the index of the type-like thing associated with this item, in
     * order that it may be written out. Subclasses must override this to get
     * whatever it is they need to store.
     *
    ...
    /**
     * Returns the field name of the type-like thing associated with this item,
     * for listing-generating purposes. Subclasses must override this.
     *
