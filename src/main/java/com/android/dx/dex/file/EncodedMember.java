...
/**
 * Representation of a member (field or method) of a class, for the purposes of
 * encoding it inside a {@link ClassDataItem}.
 */
public abstract class EncodedMember implements ToHuman {
     ...
     * @param lastIndex {@code >= 0;} the previous member index value encoded,
     * or {@code 0} if this is the first element to encode
