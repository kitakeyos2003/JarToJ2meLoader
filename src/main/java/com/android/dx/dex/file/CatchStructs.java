...
/**
 * List of exception handlers (tuples of covered range, catch type, handler
 * address) for a particular piece of code. Instances of this class correspond
 * to a {@code try_item[]} and a {@code catch_handler_item[]}.
 */
public final class CatchStructs {

    /**
     * the size of a {@code try_item}: a {@code uint} and two {@code ushort}s
     */
    ...
    /**
     * {@code null-ok;} map from handler lists to byte offsets, if calculated;
     * set in {@link #encode}
     */
    ...
    /**
     * Helper method to annotate or simply print the exception handlers. Only
     * one of {@code printTo} or {@code annotateTo} should be non-null.
     *
