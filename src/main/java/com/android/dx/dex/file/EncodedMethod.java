...
public final class EncodedMethod extends EncodedMember
     ...
     *
     * <p>
     * <b>Note:</b> This compares the method constants only, ignoring any
     * associated code, because it should never be the case that two different
     * items with the same method constant ever appear in the same list (or same
     * file, even).</p>
     */
    @Override
