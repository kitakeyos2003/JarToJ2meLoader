...
public final class ClassDefsSection extends UniformItemSection {
    ...
    /**
     * Helper for {@link #orderItems}, which recursively assigns indices to
     * classes.
     *
     * @param type {@code null-ok;} type ref to assign, if any
     * @param idx {@code >= 0;} the next index to assign
     * @param maxDepth maximum recursion depth; if negative, this will throw an
     * exception indicating class definition circularity
