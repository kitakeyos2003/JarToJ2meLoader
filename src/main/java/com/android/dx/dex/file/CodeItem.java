...
/**
 * Representation of all the parts needed for concrete methods in a {@code dex}
 * file.
 */
public final class CodeItem extends OffsettedItem {
    ...
    /**
     * {@code null-ok;} the debug info or {@code null} if there is none; set in
     * {@link #addContents}
     */
     ...
     * @param isStatic whether this instance is for a {@code static} method
