...
public final class DexFile {
     ...
     * it from {@link #wordData} helps break what would otherwise be a circular
     ...
     *
     * <p>
     * This is package-scope in order to allow the various {@link Item}
     * instances to add items to the instance.</p>
     *
     ...
     *
     * <p>
     * This is package-scope in order to allow the header section to query
     * it.</p>
     *
     ...
     *
     * <p>
     * This is public in order to allow the various {@link Item} instances to
     * add items to the instance and help early counting of type ids.</p>
     *
     ...
     * <p>
     * This is public in order to allow the various {@link Item} instances to
     * add items to the instance and help early counting of field ids.</p>
     *
     ...
     * <p>
     * This is public in order to allow the various {@link Item} instances to
     * add items to the instance and help early counting of method ids.</p>
     *
    ...
    /**
     * Gets the last section of the file that is to be considered part of the
     * data section.
     *
     * <p>
     * This is package-scope in order to allow the header section to query
    ...
    /**
     * Interns the given constant in the appropriate section of this instance,
     * or do nothing if the given constant isn't the sort that should be
     * interned.
     *
    ...
    /**
     * Gets the {@link IndexedItem} corresponding to the given constant, if it
     * is a constant that has such a correspondence, or return {@code null} if
     * it isn't such a constant. This will throw an exception if the given
     * constant <i>should</i> have been found but wasn't.
     *
     * @param cst {@code non-null;} the constant to look up
     * @return {@code null-ok;} its corresponding item, if it has a
     * corresponding item, or {@code null} if it's not that sort of constant
     */
    ...
    /**
     * Calculates the signature for the {@code .dex} file in the given array,
     * and modify the array to contain it.
     *
