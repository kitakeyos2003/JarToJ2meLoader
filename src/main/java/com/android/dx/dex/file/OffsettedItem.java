...
public abstract class OffsettedItem extends Item
     ...
     * {@inheritDoc}
     *
     * Comparisons for this class are defined to be type-major (if the types
     * don't match then the objects are not equal), with {@link #compareTo0}
     ...
     * {@inheritDoc}
     *
     * Comparisons for this class are defined to be class-major (if the classes
     * don't match then the objects are not equal), with {@link #compareTo0}
     ...
     * {@inheritDoc}
     *
     * @throws UnsupportedOperationException thrown if the write size is not yet
     * known
     */
    @Override
     ...
     *
     * @param addedTo {@code non-null;} the section this instance has been added
     * to
     ...
     * @param addedTo {@code non-null;} the section this instance has been added
     * to
     * @param offset {@code >= 0;} the offset from the start of the section
