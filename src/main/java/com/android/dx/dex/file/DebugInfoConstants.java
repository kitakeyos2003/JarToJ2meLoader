...
public interface DebugInfoConstants {
    ...
    /**
     * Advances the program counter/address register without emitting a
     * positions entry.<p>
     *
     * Args:
     * <ol>
    ...
    /**
     * Advances the line register without emitting a positions entry.<p>
     *
     * Args:
     * <ol>
    ...
    /**
     * Introduces a local variable at the current address with a type signature
     * specified.<p>
     *
     * Args:
     * <ol>
     ...
     * <li>Unsigned LEB128 &mdash; string index (shifted by 1) of local name.
     * <li>Unsigned LEB128 &mdash; type index (shifted by 1) of type.
     * <li>Unsigned LEB128 &mdash; string index (shifted by 1) of type
     * signature.
     * </ol>
     */
     ...
     * are the same as the last local that was live in the specified
     * register.<p>
     *
     * Args:
     * <ol>
     ...
     * prologue (an appropriate place for a method breakpoint)
     * .<p>
     *
     ...
     * next position entry that is added should be considered the beginning of a
     * method epilogue (an appropriate place to suspend execution before method exit)
     * .<p>
     *
     ...
     * line number entries make reference to this source file name, instead of
     * the default name specified in code_item.
     *
     * Args:
     * <ol>
     * <li>Unsigned LEB128 &mdash; string index (shifted by 1) of source file
     * name.
     * </ol>
     */
