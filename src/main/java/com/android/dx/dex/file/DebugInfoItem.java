...
public class DebugInfoItem extends OffsettedItem {
    ...
    /**
     * Writes annotations for the elements of this list, as zero-length. This is
     * meant to be used for dumping this instance directly after a code dump
     * (with the real local list actually existing elsewhere in the output).
     *
     * @param file {@code non-null;} the file to use for referencing other
     * sections
     ...
     * @param consume whether to claim to have consumed output for {@code out}
