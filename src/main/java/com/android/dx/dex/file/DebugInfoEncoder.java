...
public final class DebugInfoEncoder {
     ...
     * locals} and including all subsequent activity at the same address.
     *
     ...
     *
     * @param sortedPositions positions, sorted by ascending address
     * @param methodArgs local list entries for method argumens arguments, in
    ...
    /**
     * Emits a {@link DebugInfoConstants#DBG_START_LOCAL DBG_START_LOCAL} or      {@link DebugInfoConstants#DBG_START_LOCAL_EXTENDED
