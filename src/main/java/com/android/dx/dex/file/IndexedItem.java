...
public abstract class IndexedItem extends Item {
    ...
    /**
     * {@code >= -1;} assigned index of the item, or {@code -1} if not yet
     * assigned
     */
    private int index;
    ...
    /**
     * Sets the item index. This method may only ever be called once per
     * instance, and this will throw a {@code RuntimeException} if called a
