...
/**
 * A section of a {@code .dex} file. Each section consists of a list of items of
 * some sort or other.
 */
public abstract class Section {
    ...
    /**
     * {@code > 0;} alignment requirement for the final output; must be a power
     * of 2
     */
     ...
     * @throws IllegalArgumentException thrown if {@code alignment} isn't a
     * positive power of 2
     */
    ...
    /**
     * Gets the offset from the start of the file to this part. This throws an
     * exception if the offset has not yet been set.
     *
    ...
    /**
     * Sets the file offset. It is only valid to call this method once once per
     * instance.
     *
    ...
    /**
     * Returns the absolute file offset, given an offset from the start of this
     * instance's output. This is only valid to call once this instance has been
     * assigned a file offset (via {@link
     * #setFileOffset}).
     *
    ...
    /**
     * Returns the absolute file offset of the given item which must be
     * contained in this section. This is only valid to call once this instance
     * has been assigned a file offset (via {@link
     * #setFileOffset}).
     *
     * <p>
     * <b>Note:</b> Subclasses must implement this as appropriate for their
     * contents.</p>
     *
     ...
     * prerequisites, including particularly adding stuff to other sections.
     * This method may only be called once per instance; subsequent calls will
     * throw an exception.
     */
    ...
    /**
     * Gets the collection of all the items in this section. It is not valid to
     * attempt to change the returned list.
     *
    ...
    /**
     * Throws an exception if {@link #prepare} has not been called on this
     * instance.
     */
    ...
    /**
     * Throws an exception if {@link #prepare} has already been called on this
     * instance.
     */
    ...
    /**
     * Writes this instance to the given raw data object. This gets called by
     * {@link #writeTo} after aligning the cursor of {@code out} and verifying
     * that either the assigned file offset matches the actual cursor
     * {@code out} or that the file offset was not previously assigned, in which
     * case it gets assigned to {@code out}'s cursor.
     *
     * @param out {@code non-null;} where to write to
     */
