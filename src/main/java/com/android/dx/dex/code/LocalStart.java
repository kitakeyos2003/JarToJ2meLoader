...
/**
 * Pseudo-instruction which is used to introduce a new local variable. That is,
 * an instance of this class in an instruction stream indicates that starting
 * with the subsequent instruction, the indicated variable is bound.
 */
public final class LocalStart extends ZeroSizeInsn {

    /**
     * {@code non-null;} register spec representing the local variable
     * introduced by this instance
     */
    ...
    /**
     * Gets the register spec representing the local variable introduced by this
     * instance.
     *
