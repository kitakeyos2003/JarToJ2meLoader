 ...
 * Instances are used for such things as branch targets and exception handler
 * ranges. Its code size is zero, and so instances do not in general directly
 * wind up in any output (either human-oriented or binary file).
 */
