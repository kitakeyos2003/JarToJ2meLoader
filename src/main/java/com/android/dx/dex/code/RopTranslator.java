...
public final class RopTranslator {
    ...
    /**
     * how much position info to preserve; one of the static constants in
     * {@link PositionList}
     */
    ...
    /**
     * {@code null-ok;} block output order; becomes non-null in
     * {@link #pickOrder}
     */
    private int[] order;
    ...
    /**
     * true if the parameters to this method happen to be in proper order at the
     * end of the frame (as the optimizer emits them)
     */
     ...
     * @param positionInfo how much position info to preserve; one of the static
     * constants in {@link PositionList}
     * @param locals {@code null-ok;} local variable information to use
     * @param paramSize size, in register units, of all the parameters to this
     * method
    ...
    /**
     * Checks to see if the move-param instructions that occur in this method
     * happen to slot the params in an order at the top of the stack frame that
     * matches dalvik's calling conventions. This will alway result in "true"
     * for methods that have run through the SSA optimizer.
     *
     * @param paramSize size, in register units, of all the parameters to this
     * method
     */
    ...
    /**
     * Performs initial creation of output instructions based on the original
     * blocks.
     */
    ...
    /**
     * Helper for {@link #outputInstructions}, which does the processing and
     * output of one block.
     *
    ...
    /**
     * Gets the complete register list (result and sources) out of a given rop
     * instruction. For insns that are commutative, have two register sources,
     * and have a source equal to the result, place that source first.
     *
     ...
     *
     * @param insn {@code non-null;} instruction in question
     * @param resultReg {@code null-ok;} the real result to use (ignore the
     * insn's)
     * @return {@code non-null;} the instruction's complete register list
     */
    private static RegisterSpecList getRegs(Insn insn,
    ...
    private class TranslationVisitor implements Insn.Visitor {
        ...
        /**
         * Looks forward to the current block's primary successor, returning the
         * RegisterSpec of the result of the move-result-pseudo at the top of
         * that block or null if none.
         *
         * @return {@code null-ok;} result of move-result-pseudo at the
         * beginning of primary successor
         */
    ...
    /**
     * Instruction visitor class for doing instruction translation with local
     * variable tracking
     */
    private class LocalVariableAwareTranslationVisitor
        ...
        /**
         * Adds a {@link LocalStart} to the output if the given instruction in
         * fact introduces a local variable.
         *
         * @param insn {@code non-null;} instruction in question
         */
