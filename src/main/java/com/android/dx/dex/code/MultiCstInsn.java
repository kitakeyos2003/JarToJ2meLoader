...
/**
 * An instruction with multiple constant arguments in addition to all the normal
...
public final class MultiCstInsn extends FixedSizeInsn {
    ...
    /**
     * Returns whether the class index associated with this instruction has been
     * set.
     *
     * @see #setClassIndex
     *
     ...
     * reference constants have a class, so it is only on instances with
     * reference constants that this method should ever be called. It is only
     * valid to call this method once per instance.
     *
