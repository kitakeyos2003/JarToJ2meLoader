...
/**
 * Pseudo-instruction which holds switch data. The switch data is a map of
 * values to target addresses, and this class writes the data in either a
 * "packed" or "sparse" form.
 */
public final class SwitchData extends VariableSizeInsn {
    ...
    /**
     * {@code non-null;} corresponding list of code addresses; the branch target
     * for each case
     */
     ...
     * @param targets {@code non-null;} corresponding list of code addresses;
     * the branch target for each case
     */
     ...
     * @return {@code >= -1;} the packed table size or {@code -1} if the cases
     * couldn't possibly be represented as a packed table
     */
     ...
     *
     * @param cases {@code non-null;} sorted list of cases
     * @return {@code true} iff the table encoding the cases should be packed
     */
