...
/**
 * Instruction which has a single constant argument in addition to all the
...
public final class CstInsn extends FixedSizeInsn {
     ...
     * unknown ({@code -1}) as is the constant pool index.
     *
    ...
    /**
     * Sets the constant's index. It is only valid to call this method once per
     * instance.
     *
    ...
    /**
     * Sets the constant's class index. This is the constant pool index for the
     * class referred to by this instance's constant. Only reference constants
     * have a class, so it is only on instances with reference constants that
     * this method should ever be called. It is only valid to call this method
     * once per instance.
     *
     * @param index {@code index >= 0;} the constant's class's constant pool
     * index
     */
