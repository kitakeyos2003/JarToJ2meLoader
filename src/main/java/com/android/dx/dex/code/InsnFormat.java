...
public abstract class InsnFormat {
     ...
     *
     * <p>
     * Subclasses must override this method.</p>
     *
     * @param insn {@code non-null;} the instruction
     * @return {@code non-null;} the string form
     */
     ...
     * Subclasses must override this method if they have registers.</p>
     *
     * @param insn {@code non-null;} the instruction to check
     ...
     * Subclasses must override this method if they include branch offsets.</p>
     *
     * @param insn {@code non-null;} the instruction to check
     ...
     *
     * @param value the value
     * @param width the width of the constant, in bits (used for displaying the
