...
/**
 * List of source position entries. This class includes a utility method to
 * extract an instance out of a {@link DalvInsnList}.
 */
public final class PositionList extends FixedSizeList {
    ...
    /**
     * constant for {@link #make} to indicate that only line number transitions
     * should be returned
     */
     ...
     * @param howMuch how much information should be included; one of the static
    ...
    public static class Entry {
         ...
         * @param position {@code non-null;} corresponding source position
         * information
         */
