...
/**
 * List of local variables. Each local variable entry indicates a range of code
 * which it is valid for, a register number, a name, and a type.
 */
public final class LocalList extends FixedSizeList {
    ...
    public static enum Disposition {
        ...
        END_MOVED,
        /**
         * local ended because the previous local clobbered this one (because it
         * is category-2)
         */
        END_CLOBBERED_BY_PREV,
        /**
         * local ended because the next local clobbered this one (because this
         * one is a category-2)
         */
    ...
    public static class Entry implements Comparable<Entry> {
        ...
        /**
         * Compares by (in priority order) address, end then start disposition
         * (variants of end are all consistered equivalent), and spec.
         *
         ...
         *
         * @return {@code >= 0;} the number of the register holding the variable
         */
         ...
         * @return {@code true} iff this instance matches {@code spec}
         */
        ...
        /**
         * Returns whether or not this instance matches the spec in the given
         * instance.
         *
         * @param other {@code non-null;} another entry
         * @return {@code true} iff this instance's spec matches {@code other}
         */
        ...
        /**
         * Returns an instance just like this one but with the disposition set
         * as given.
         *
    ...
    /**
     * Constructs an instance for the given method, based on the given block
     * order and intermediate local information.
     *
    ...
    /**
     * Debugging helper that verifies the constraint that a list doesn't contain
     * any redundant local starts and that local ends that are due to
    ...
    public static class MakeState {
        ...
        /**
         * Checks the address and other vitals as a prerequisite to further
         * processing.
         *
        ...
        /**
         * Sets the local state at the given address to the given snapshot. The
         * first call on this instance must be to this method, so that the
         * register state can be properly sized.
         *
         ...
         *
         * @param address {@code >= 0;} the address
         * @param startedLocal {@code non-null;} spec representing the started
         * local
         */
 ...
 /*
         ...
         *
         * @param address {@code >= 0;} the address
         * @param endedLocal {@code non-null;} spec representing the local being
         * ended
         */
        ...
        /**
         * Helper for {@link #endLocal}, which handles the cases where and end
         * local is issued at the same address as a start local for the same
         * register. If this case is found, then this method will remove the
         * start (as the local was never actually active), update the
         * {@link #endIndices} to be accurate, and if needed update the
         * newly-active end to reflect an altered disposition.
         *
         * @param address {@code >= 0;} the address
         * @param endedLocal {@code non-null;} spec representing the local being
         * ended
         * @return {@code true} iff this method found the case in question and
        ...
        /**
         * Converts a given spec into the form acceptable for use in a local
         * list. This, in particular, transforms the "known null" type into
         * simply {@code Object}. This method needs to be called for any spec
         * that is on its way into a locals list.
         *
         * <p>
         * This isn't necessarily the cleanest way to achieve the goal of not
         * representing known nulls in a locals list, but it gets the job
         * done.</p>
         *
        ...
        /**
         * Adds or updates an end local (changing its disposition). If this
         * would cause an empty range for a local, this instead removes the
         * local entirely.
         *
         * @param address {@code >= 0;} the address
         * @param disposition {@code non-null;} the disposition
