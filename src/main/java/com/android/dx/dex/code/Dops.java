...
public final class Dops {
     ...
     * @param options {@code non-null;} options, used to determine which opcodes
     * are potentially off-limits
     * @return {@code null-ok;} the next opcode in the same family, in the chain
     * of opcodes to try, or {@code null} if the given opcode is the last in its
     * chain
     */
