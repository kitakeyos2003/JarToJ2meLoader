...
/**
 * Container for all the pieces of a concrete method. Each instance corresponds
 * to a {@code code} structure in a {@code .dex} file.
 */
public final class DalvCode {
    ...
    /**
     * {@code null-ok;} the instruction list, ready for final processing; nulled
     * out in {@link #finishProcessingIfNecessary}
     */
    private OutputFinisher unprocessedInsns;

    /**
     * {@code non-null;} unprocessed catch table; nulled out in
     ...
     * @param unprocessedInsns {@code non-null;} the instruction list, ready for
     * final processing
     * @param unprocessedCatches {@code non-null;} unprocessed catch (exception
     * handler) table
     */
    ...
    /**
     * Assign indices in all instructions that need them, using the given
     * callback to perform lookups. This must be called before
     * {@link #getInsns}.
     *
     ...
     *
     * @return {@code true} iff this instance has any position data to represent
     */
     ...
     *
     * @return {@code true} iff this instance has any local variable data to
     * represent
     */
    ...
    /**
     * Gets whether this instance has any catches at all (either typed or
     * catch-all).
     *
