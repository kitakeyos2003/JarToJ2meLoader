...
/**
 * Container for the set of {@link CodeAddress} instances associated with the
 * blocks of a particular method. Each block has a corresponding start address,
 * end address, and last instruction address.
 */
public final class BlockAddresses {
    ...
    /**
     * {@code non-null;} array containing addresses for the final instruction of
     * each basic block (indexed by basic block label)
     */
    private final CodeAddress[] lasts;

    /**
     * {@code non-null;} array containing addresses for the end (just past the
     * final instruction) of each basic block (indexed by basic block label)
     */
    ...
    /**
     * Gets the instance for the end (address after the final instruction) of
     * the given block.
     *
     * @param block {@code non-null;} the block in question
     * @return {@code non-null;} the appropriate instance
