...
public final class DalvInsnList extends FixedSizeList {
    ...
    /**
     * The amount of register space, in register units, required for this code
     * block. This may be greater than the largest observed register+ category
     * because the method this code block exists in may specify arguments that
     * are unused by the method.
     */
    private final int regCount;

    /**
     * Constructs and returns an immutable instance whose elements are identical
     * to the ones in the given list, in the same order.
     *
     * @param list {@code non-null;} the list to use for elements
     * @param regCount count, in register-units, of the number of registers this
     * code block requires.
     ...
     * return a meaningful result if the instructions in this instance all have
     * valid addresses.
     *
     ...
     * includes any unused parameters that could potentially be at the top of
     * the register space.
     *
     ...
     * This is equal to the largest argument word count of any method referred
     * to by this instance.
     *
     ...
     * @param verbose whether to be verbose; verbose output includes lines for
     * zero-size instructions and explicit constant pool indices
     */
