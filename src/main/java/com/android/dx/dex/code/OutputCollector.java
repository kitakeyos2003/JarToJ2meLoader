...
/**
 * Destination for {@link DalvInsn} instances being output. This class receives
 * and collects instructions in two pieces &mdash; a primary list and a suffix
 * (generally consisting of adjunct data referred to by the primary list, such
 * as switch case tables) &mdash; which it merges and emits back out in the form
 * of a {@link DalvInsnList} instance.
 */
public final class OutputCollector {
    ...
    /**
     * {@code null-ok;} suffix for the output, or {@code null} if the suffix has
     * been appended to the main output (by {@link #appendSuffixToOutput})
     */
    ...
    /**
     * Gets the results of all the calls on this instance, in the form of an
     * {@link OutputFinisher}.
     *
    ...
    /**
     * Helper for {@link #getFinisher}, which appends the suffix to the primary
     * output.
     */
