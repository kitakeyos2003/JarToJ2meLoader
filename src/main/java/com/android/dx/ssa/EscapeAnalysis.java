...
public class EscapeAnalysis {
     ...
     *
     * TOP - Used for objects that haven't been analyzed yet NONE - Object does
     * not escape, and is eligible for scalar replacement. METHOD - Object
     * remains local to method, but can't be scalar replaced. INTER - Object is
     * passed between methods. (treated as globally escaping since this is an
     * intraprocedural analysis) GLOBAL - Object escapes globally.
     */
    ...
    /**
     * Finds the index in the lattice for a particular register. Returns the
     * size of the lattice if the register wasn't found.
     *
     ...
     *
     * @param insn {@code non-null;} an instruction that must always be followed
     * by a move result
     ...
     * into is the parent. A child set must always have an escape state at least
     * as high as its parent.
     *
    ...
    /**
     * Process a single instruction, looking for new objects resulting from move
     * result or move param.
     *
    ...
    /**
     * Inserts a new PlainInsn before the given instruction. TODO: move this
    ...
    /**
     * Inserts a new ThrowingInsn before the given instruction. TODO: move this
     * somewhere more appropriate
     *
     * @param insn {@code non-null;} instruction to insert before
     * @param newSources {@code non-null;} sources of new instruction
