...
/**
 * Calculates the dominance-frontiers of a method's basic blocks. Algorithm from
...
public class DomFront {
    ...
    /**
     * The dominators algorithm leaves us knowing who the immediate dominator is
     * for each node. This sweeps the node list and builds the proper dominance
     * tree.
     */
    ...
    /**
     * Calculates the dominance-frontier set. from "A Simple, Fast Dominance
     * Algorithm" by Cooper, Harvey, and Kennedy; transliterated to Java.
     */
