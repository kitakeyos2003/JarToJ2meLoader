...
public final class SetFactory {
     ...
     * itself, very sparse at large sizes.
     *
     ...
     * are kept per register until register allocation is done.
     *
     * A value of 3072 here is somewhere around 1.125mb of total bitset size.
     */
     ...
     *
     * The total size of a bitset for this would be the count of blocks times
     * the size of registers. The threshold value here is merely the register
     * count, which is typically on the order of the block count as well.
     */
