...
/**
 * Represents a mapping between two register numbering schemes. Subclasses of
 * this may be mutable, and as such the mapping provided is only valid for the
 * lifetime of the method call in which instances of this class are passed.
 */
