...
public abstract class RegisterAllocator {
    ...
    /**
     * Indicates whether the method params were allocated at the bottom of the
     * namespace, and thus should be moved up to the top of the namespace after
     * phi removal.
     *
    ...
    /**
     * Returns true if the definition site of this register is a move-param (ie,
     ...
     * interference graph in the process. The insn currently must be the last
     * insn in a block.
     *
     * @param insn {@code non-null;} insn to insert move before, must be last
     * insn in block
