...
/**
 * Allocates registers via a naive n^2 register allocator. This allocator does
 * not try to co-locate local variables or deal intelligently with different
 * size register uses.
 */
public class FirstFitAllocator extends RegisterAllocator {

    /**
     * If true, allocator places parameters at the top of the frame in
