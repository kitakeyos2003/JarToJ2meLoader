...
public class InterferenceGraph {
    ...
    /**
     * {@code non-null;} interference graph, indexed by register in both
     * dimensions
     */
     ...
     * Creates a new graph.
     *
     * @param countRegs {@code >= 0;} the start count of registers in the
     * namespace. New registers can be added subsequently.
     */
    ...
    /**
     * Adds a register pair to the interference/liveness graph. Parameter order
     * is insignificant.
     *
     ...
     * @param set {@code non-null;} interference set; will be merged with set
     * for given register
     */
