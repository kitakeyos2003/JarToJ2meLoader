...
public class Optimizer {
    ...
    /**
     * @return true if local variable information should be preserved, even at
     * code size/register size cost
     */
    ...
    /**
     * Runs optimization algorthims over this method, and returns a new instance
     * of RopMethod with the changes.
     *
     ...
     * forms that take register numbers larger than 15 for all instructions. If
     * we've produced a method that uses more than 16 registers, try again with
     * a different strategy to see if we can get under the bar. The end result
