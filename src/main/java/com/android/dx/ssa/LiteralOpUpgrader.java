 ...
 * Also switches IF instructions that compare with a constant zero or null to be
 * their IF_*Z equivalents.
 */
public class LiteralOpUpgrader {
    ...
    /**
     * Returns true if the register contains an integer 0 or a known-null object
     * reference
     *
    ...
    /**
     * Replaces an SsaInsn containing a PlainInsn with a new PlainInsn. The new
     * PlainInsn is constructed with a new RegOp and new sources.
     *
