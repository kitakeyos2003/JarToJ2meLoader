...
public class SsaRenamer implements Runnable {
     ...
     *
     * @param ssaMeth {@code non-null;} un-renamed SSA method that will be
     * renamed.
     */
    ...
    private class BlockRenamer implements SsaInsn.Visitor {
         ...
         * @param ssaReg {@code non-null;} an SSA register that has just been
         * added to {@code currentMapping}
         */
         ...
         * {@inheritDoc}
         *
         * Move insns are treated as a simple mapping operation, and will later
         * be removed unless they represent a local variable assignment. If they
         * represent a local variable assignement, they are preserved.
         */
        @Override
