...
public class SsaConverter {
     ...
     *
     * Converts CFG into "edge-split" form, such that each node either a unique
     * successor or unique predecessor.<p>
     *
     ...
     *
     * @param ssaMeth {@code non-null;} method to process. Modifications are
     * made in-place.
     * @param localInfo {@code non-null;} local variable info, used when placing
     * phis
