...
/**
 * This class maps one register space into another, with each mapping built up
 * individually and added via addMapping()
 */
public class BasicRegisterMapper extends RegisterMapper {
    ...
    /**
     * Returns the new-namespace mapping for the specified old-namespace
     * register, or -1 if one exists.
     *
