...
/**
 * Very simple base class that implements a flag to control the mutability of
 * instances. This class just provides the flag and a utility to check and throw
 * the right exception, but it is up to subclasses to place calls to the checker
...
public class MutabilityControl {
    ...
    /**
     * Checks to see whether or not this instance is immutable. This is the same
     * as calling {@code !isMutable()}.
     *
