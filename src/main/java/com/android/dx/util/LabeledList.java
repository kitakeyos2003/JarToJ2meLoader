...
public class LabeledList extends FixedSizeList {
    ...
    /**
     * Sparse array indexed by label to FixedSizeList index; {@code -1} for an
     * invalid label.
     */
    ...
    /**
     * Gets the index of the first item in the list with the given label, if
     * any.
     *
    ...
    /**
     * Rebuilds the label-to-index mapping after a {@code shrinkToFit()}. Note:
     * This assumes that the labels that are in the list are the same, although
     * the indicies may have changed.
     */
