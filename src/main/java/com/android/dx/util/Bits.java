...
public final class Bits {
    ...
    /**
     * Returns whether or not the given bit set is empty, that is, whether no
     * bit is set to {@code true}.
     *
     * @param bits {@code non-null;} bit set to operate on
    ...
    /**
     * Returns whether any bits are set to {@code true} in the specified range.
     *
     * @param bits {@code non-null;} bit set to operate on
     * @param start {@code >= 0;} index of the first bit in the range
     * (inclusive)
     * @param end {@code >= 0;} index of the last bit in the range (exclusive)
     * @return {@code true} if any bit is set to {@code true} in the indicated
     * range
     */
    ...
    /**
     * Finds the lowest-order bit set at or after the given index in the given
     * bit set.
     *
     * @param bits {@code non-null;} bit set to operate on
     * @param idx {@code >= 0;} minimum index to return
     * @return {@code >= -1;} lowest-order bit set at or after {@code idx}, or
     * {@code -1} if there is no appropriate bit index to return
     */
    ...
    /**
     * Ors bit array {@code b} into bit array {@code a}. {@code a.length} must
     * be greater than or equal to {@code b.length}.
     *
