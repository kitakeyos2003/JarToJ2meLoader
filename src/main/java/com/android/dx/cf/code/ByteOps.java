...
/**
 * Constants and utility methods for dealing with bytecode arrays at an opcode
 * level.
 */
public class ByteOps {
    ...
    /**
     * "l": {@code op local}; category-1 local; implies {@code max_locals} is at
     * least two more than the given local number
     */
    public static final int FMT_LOCAL_1 = 10;

    /**
     * "m": {@code op local}; category-2 local; implies {@code max_locals} is at
     * least two more than the given local number
     */
