...
public final class ByteCatchList extends FixedSizeList {
     ...
     *
     * @param n {@code >= 0, < size();} which entry to set
     * @param startPc {@code >= 0;} the start pc (inclusive) of the handler's
     * range
     * @param endPc {@code >= startPc;} the end pc (exclusive) of the handler's
     * range
     ...
     * @param count {@code non-null;} maximum number of elements in the array to
     * check
