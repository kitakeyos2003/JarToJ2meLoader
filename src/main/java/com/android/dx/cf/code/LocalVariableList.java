 ...
 * {@code LocalVariableTable} and {@code LocalVariableTypeTable} attributes, as
...
public final class LocalVariableList extends FixedSizeList {
    ...
    /**
     * Returns an instance which is the result of merging the two given
     * instances, where one instance should have only type descriptors and the
     * other only type signatures. The merged result is identical to the one
     * with descriptors, except that any element whose {name, index, start,
     * length} matches an element in the signature list gets augmented with the
     ...
     *
     * <p>
     * <b>Note:</b> At least one of {@code descriptor} or {@code signature} must
     * be passed as non-null.</p>
     *
     * @param n {@code >= 0, < size();} which element
    ...
    /**
     * Gets the local variable information in this instance which matches the
     * given {@link com.android.dx.cf.code.LocalVariableList.Item} in all
     * respects but the type descriptor and signature, if any.
     *
     * @param item {@code non-null;} local variable information to match
     * @return {@code null-ok;} the corresponding local variable information
     * stored in this instance, or {@code null} if there is no matching
     * information
     */
    ...
    /**
     * Gets the local variable information associated with a given address and
     * local index, if any. <b>Note:</b> In standard classfiles, a variable's
     * start point is listed as the address of the instruction
    ...
    public static class Item {
         ...
         *
         * <p>
         * <b>Note:</b> At least one of {@code descriptor} or {@code signature}
         * must be passed as non-null.</p>
         *
         * @param startPc {@code >= 0;} the start pc of this variable's scope
         * @param length {@code >= 0;} the length (in bytecodes) of this
         * variable's scope
         * @param name {@code non-null;} the variable's name
         * @param descriptor {@code null-ok;} the variable's type descriptor
         * @param signature {@code null-ok;} the variable's type signature
        ...
        /**
         * Constructs and returns an instance which is identical to this one,
         * except that the signature is changed to the given value.
         *
        ...
        /**
         * Gets whether this instance matches (describes) the given address and
         * index.
         *
         * @param pc {@code >= 0;} the address in question
         * @param index {@code >= 0;} the local variable index in question
         * @return {@code true} iff this instance matches {@code pc} and
         * {@code index}
         */
        ...
        /**
         * Gets whether this instance matches (describes) the given other
         * instance exactly in all fields except type descriptor and type
         * signature.
         *
