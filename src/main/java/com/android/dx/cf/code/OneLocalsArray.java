...
public class OneLocalsArray extends LocalsArray {
     ...
     * A more-refined version of {@link #merge(LocalsArray) merge} which is
     * called by that method when appropriate.
     *
     * @param other locals array with which to merge
     * @return this instance if merge was a no-op, or a new instance if the
     * merge resulted in a change.
     */
