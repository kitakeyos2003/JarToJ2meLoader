 ...
 * {@code tableswitch} or {@code lookupswitch} instruction. It also holds the
 * default target for the switch.
 */
public final class SwitchList extends MutabilityControl {
     ...
     * is always one extra element in the target list, to hold the default
     * target
     */
    ...
    /**
     * Gets the list of all targets. This includes one extra element at the end
     * of the list, which holds the default target.
     *
    ...
    /**
     * Sets the default target. It is only valid to call this method when all
     * the non-default elements have been set.
     *
    ...
    /**
     * Shrinks this instance if possible, removing test elements that refer to
     * the default target. This is only valid after the instance is fully
     * populated, including the default target (naturally).
     */
