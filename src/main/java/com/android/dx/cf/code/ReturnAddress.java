...
/**
 * Representation of a subroutine return address. In Java verification, somewhat
 * counterintuitively, the salient bit of information you need to know about a
 * return address is the <i>start address</i> of the subroutine being returned
 * from, not the address being returned <i>to</i>, so that's what instances of
 * this class hang onto.
 */
