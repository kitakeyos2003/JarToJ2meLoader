...
public final class Merger {
    ...
    /**
     * Returns whether the given supertype is possibly assignable from the given
     * subtype. This takes into account primitiveness, int-likeness,
     * known-nullness, and array dimensions, but does not assume anything about
     * class hierarchy other than that the type {@code Object} is the supertype
     * of all reference types and all arrays are assignable to
