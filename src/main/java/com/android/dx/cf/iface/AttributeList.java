...
public interface AttributeList {
    ...
    /**
     * Get whether this instance is mutable. Note that the {@code AttributeList}
     * interface itself doesn't provide any means of mutation, but that doesn't
     * mean that there isn't a non-interface way of mutating an instance.
     *
     ...
     * The returned value includes the two bytes for the
