...
/**
 * Observer of parsing in action. This is used to supply feedback from the
 * various things that parse particularly to the dumping utilities.
 */
public interface ParseObserver {

    /**
     * Indicate that the level of indentation for a dump should increase or
     * decrease (positive or negative argument, respectively).
     *
     ...
     * @param offset offset into {@code bytes} for the start of the member
     ...
     * @param offset offset into {@code bytes} for the end of the member
     * @param name {@code non-null;} name of the member
     * @param descriptor {@code non-null;} descriptor of the member
