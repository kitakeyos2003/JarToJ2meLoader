...
/**
 * Interface for things which purport to be class files or reasonable facsimiles
 * thereof.
 *
 * <p>
 * <b>Note:</b> The fields referred to in this documentation are of the
...
public interface ClassFile extends HasAttribute {
    ...
    /**
     * Gets the field {@code super_class}, interpreted as a type constant if
     * non-zero.
     *
    ...
    /**
     * Gets the name out of the {@code SourceFile} attribute of this file, if
     * any. This is a convenient shorthand for scrounging around the class's
     * attributes.
     *
     * @return {@code non-null;} the constant pool
     */
