...
public final class AttConstantValue extends BaseAttribute {
     ...
     *
     * @param constantValue {@code non-null;} the constant value, which must be
     * an instance of one of: {@code CstString}, {@code CstInteger},
     * {@code CstLong}, {@code CstFloat}, or {@code CstDouble}
     */
    ...
    /**
     * Gets the constant value of this instance. The returned value is an
     * instance of one of: {@code CstString}, {@code CstInteger},
     * {@code CstLong}, {@code CstFloat}, or {@code CstDouble}.
     *
