...
public final class AnnotationParser {
    ...
    /**
     * {@code non-null;} cursor for use when informing the observer of what was
     * parsed
     */
     ...
     *
     * @param visibility {@code non-null;} visibility of the parsed annotations
     * @return {@code non-null;} the list of annotation lists read from the
     * attribute data
     */
    ...
    /**
     * Helper for {@link #parseValue}, which parses a constant reference and
     * returns the referred-to constant value.
     *
     * @return {@code non-null;} the parsed value
     */
    ...
    /**
     * Helper which will throw an exception if the given number of bytes is not
    ...
    /**
     * Helper which indicates that some bytes were just parsed. This should only
     * be used (for efficiency sake) if the parse is known to be observed.
     *
