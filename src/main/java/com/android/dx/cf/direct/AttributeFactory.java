...
public class AttributeFactory {
    ...
    /**
     * Parses and makes an attribute based on the bytes at the indicated
     * position in the given array. This method figures out the name, and then
     * does all the setup to call on to {@link #parse0}, which does the actual
     * construction.
     *
     * @param cf {@code non-null;} class file to parse from
     * @param context context to parse in; one of the {@code CTX_*} constants
     * @param offset offset into {@code dcf}'s {@code bytes} to start parsing at
     ...
     * an instance of {@link RawAttribute}. Subclasses are expected to override
     * this to do something better in most cases.
     *
     * @param cf {@code non-null;} class file to parse from
     * @param context context to parse in; one of the {@code CTX_*} constants
     * @param name {@code non-null;} the attribute name
     * @param offset offset into {@code bytes} to start parsing at; this is the
     * offset to the start of attribute data, not to the header
