...
public class CodeObserver implements BytecodeArray.Visitor {
    ...
    /**
     * Helper for {@link #visitConstant} where the constant is an {@code int}.
     *
    ...
    /**
     * Helper for {@link #visitConstant} where the constant is a {@code long}.
     *
     * @param opcode the opcode
     * @param offset offset to the instruction
     * @param length instruction length
    ...
    /**
     * Helper for {@link #visitConstant} where the constant is a {@code float}.
     *
     * @param opcode the opcode
     * @param offset offset to the instruction
     * @param length instruction length
    ...
    /**
     * Helper for {@link #visitConstant} where the constant is a {@code double}.
     *
     * @param opcode the opcode
     * @param offset offset to the instruction
     * @param length instruction length
