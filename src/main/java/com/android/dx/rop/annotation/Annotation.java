...
/**
 * An annotation on an element of a class. Annotations have an associated type
 * and additionally consist of a set of (name, value) pairs, where the names are
 * unique.
 */
public final class Annotation extends MutabilityControl
    ...
    /**
     * Put an element into the set of (name, value) pairs for this instance. If
     * there is a preexisting element with the same name, it will be replaced by
     * this method.
     *
     * @param pair {@code non-null;} the (name, value) pair to place into this
     * instance
     */
    ...
    /**
     * Add an element to the set of (name, value) pairs for this instance. It is
     * an error to call this method if there is a preexisting element with the
     * same name.
     *
     * @param pair {@code non-null;} the (name, value) pair to add to this
     * instance
     */
    ...
    /**
     * Gets the set of name-value pairs contained in this instance. The result
     * is always unmodifiable.
     *
