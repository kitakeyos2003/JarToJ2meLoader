...
public final class Annotations extends MutabilityControl
    ...
    /**
     * Constructs an immutable instance which is the combination of the two
     * given instances. The two instances must contain disjoint sets of types.
     *
    ...
    /**
     * Constructs an immutable instance which is the combination of the given
     * instance with the given additional annotation. The latter's type must not
     * already appear in the former.
     *
    ...
    /**
     * Adds an element to this instance. There must not already be an element of
     * the same type.
     *
    ...
    /**
     * Adds all of the elements of the given instance to this one. The instances
     * must not have any duplicate types.
     *
    ...
    /**
     * Gets the set of annotations contained in this instance. The result is
     * always unmodifiable.
     *
