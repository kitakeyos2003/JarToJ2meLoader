...
public final class StdTypeList
    ...
    /**
     * Returns the given list as a comma-separated list of human forms. This is
     * a static method so as to work on arbitrary {@link TypeList} instances.
     *
    ...
    /**
     * Returns a hashcode of the contents of the given list. This is a static
     * method so as to work on arbitrary {@link TypeList} instances.
     *
    ...
    /**
     * Compares the contents of the given two instances for equality. This is a
     * static method so as to work on arbitrary {@link TypeList} instances.
     *
    ...
    /**
     * Compares the contents of the given two instances for ordering. This is a
     * static method so as to work on arbitrary {@link TypeList} instances.
     *
     * @param list1 {@code non-null;} one list to compare
     * @param list2 {@code non-null;} another list to compare
     ...
     * it has an additional type prepended to the original.
     *
