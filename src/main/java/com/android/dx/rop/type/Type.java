...
/**
 * Representation of a value type, such as may appear in a field, in a local, on
 * a stack, or in a method descriptor. Instances of this class are generally
...
public final class Type implements TypeBearer, Comparable<Type> {
     ...
     *
     * <p>
     * The initial capacity is based on a medium-size project.
     */
     ...
     * suffix on the name helps disambiguate this from the instance representing
     * a primitive type
     */
    ...
    /**
     * Put the constant fields, including primitive types in to the intern
     * table.
     *
     * <p>
     * Must be called after the types are initialized above.
     */
     ...
     * instance was allocated at; {@code Integer.MAX_VALUE} if it was an
     * incoming uninitialized instance; {@code -1} if this is an
     * <i>inititialized</i> instance
     */
    private final int newAt;

    /**
     * {@code null-ok;} the internal-form class name corresponding to this type,
     * if calculated; only valid if {@code this} is a reference type and
    ...
    /**
     * Returns the unique instance corresponding to the type with the given
     * descriptor. See vmspec-2 sec4.3.2 for details on the field descriptor
     * syntax. This method does <i>not</i> allow {@code "V"} (that is, type
     * {@code void}) as a valid descriptor.
     *
     * @param descriptor {@code non-null;} the descriptor
     * @return {@code non-null;} the corresponding instance
     * @throws IllegalArgumentException thrown if the descriptor has invalid
     * syntax
     */
    ...
    /**
     * Returns the unique instance corresponding to the type with the given
     * descriptor, allowing {@code "V"} to return the type for {@code void}.
     * Other than that one caveat, this method is identical to {@link #intern}.
     *
     * @param descriptor {@code non-null;} the descriptor
     * @return {@code non-null;} the corresponding instance
     * @throws IllegalArgumentException thrown if the descriptor has invalid
    ...
    /**
     * Returns the unique instance corresponding to the type of the class with
     * the given name. Calling this method is equivalent to calling
     * {@code intern(name)} if {@code name} begins with {@code "["} and calling
     * {@code intern("L" + name + ";")} in all other cases.
     *
     * @param name {@code non-null;} the name of the class whose type is desired
     * @return {@code non-null;} the corresponding type
     * @throws IllegalArgumentException thrown if the name has invalid syntax
     */
    ...
    /**
     * Constructs an instance corresponding to an "uninitialized type." This is
     * a private constructor; use one of the public static methods to get
     * instances.
     *
    ...
    /**
     * Constructs an instance corresponding to an "initialized type." This is a
     * private constructor; use one of the public static methods to get
     * instances.
     *
     * @param descriptor {@code non-null;} the field descriptor for the type
     * @param basicType basic type corresponding to this type; one of the
     ...
     * This method is only valid if this instance is for a normal reference type
     * (that is, a reference type and additionally not a return address).
     *
    ...
    /**
     * Gets the category. Most instances are category 1. {@code long} and
     * {@code double} are the only category 2 types.
     *
     * @see #isCategory1
     * @see #isCategory2
     * @return the category
    ...
    /**
     * Gets whether this type is a normal reference type. A normal reference
     * type is a reference type that is not a return address. This method is
     * just convenient shorthand for {@code getBasicType() == Type.BT_OBJECT}.
     *
     ...
     * {@code true}, then it is safe to use {@link #getComponentType} to
    ...
    /**
     * Gets whether this type is an array type or is a known-null, and hence is
     * compatible with array types.
     *
     * @return whether this type is an array type
     */
     ...
     * uninitialized instance is what one gets back from the {@code new} opcode,
     * and remains uninitialized until a valid constructor is invoked on it.
     *
    ...
    /**
     * Gets the initialized type corresponding to this instance, but only if
     * this instance is in fact an uninitialized object type.
     *
    ...
    /**
     * Gets the component type of this type. This method is only valid on array
     * types.
     *
    ...
    /**
     * Returns a new interned instance which is identical to this one, except it
     * is indicated as uninitialized and allocated at the given bytecode index.
     * This instance must be an initialized object type.
     *
