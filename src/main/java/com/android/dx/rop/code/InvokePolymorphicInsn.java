...
public class InvokePolymorphicInsn extends Insn {
    ...
    /**
     * {@code non-null;} method to invoke, either
    ...
    /**
     * Gets the call site prototype. The call site prototype is provided as an
     * argument to invoke-polymorphic to enable type checking and type
     * conversion.
     *
