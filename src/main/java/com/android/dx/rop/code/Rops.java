...
public final class Rops {
     ...
     *
     * Note that this rop-form instruction has no dex-form equivilent and must
     * be removed before the dex conversion.
     */
     ...
     * returned. TODO: Revisit this issue.</p>
     *
     ...
     * @param count {@code count >= 0;} number of elements that the array should
     * have
     * @return {@code non-null;} an appropriate instance
     */
    ...
    /**
     * Returns the appropriate {@code invoke-polymorphic} rop for the given
