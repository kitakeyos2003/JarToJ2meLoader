...
public final class Rop {
    ...
    /**
     * the branchingness of this op; one of the {@code BRANCH_*} constants in
     * this class
     */
    ...
    /**
     * Constructs an instance. This method is private. Use one of the public
     * constructors.
     *
     ...
     * @param sources {@code non-null;} types of all the sources of this
     * operation
     ...
     * {@code branchingness} is always {@code BRANCH_NONE}, and it is never a
     * call-like op (see {@link #isCallLike}).
     *
     * @param opcode the opcode; one of the constants in {@link RegOps}
     * @param result {@code non-null;} result type of this operation; {@link
    ...
    /**
     * Constructs a non-empty exceptions instance. Its {@code branchingness} is
     * always {@code BRANCH_THROW}, but it is never a call-like op (see
     * {@link #isCallLike}).
     *
     * @param opcode the opcode; one of the constants in {@link RegOps}
     * @param result {@code non-null;} result type of this operation; {@link
    ...
    /**
     * Constructs a non-nicknamed instance with non-empty exceptions, which is
     * always a call-like op (see {@link #isCallLike}). Its
    ...
    /**
     * Gets the result type. A return value of {@link Type#VOID} means this
    ...
    /**
     * Gets the nickname. If this instance has no nickname, this returns the
     * result of calling {@link #toString}.
     *
    ...
    /**
     * Gets whether this operation can possibly throw an exception. This is just
     * a convenient wrapper for {@code getExceptions().size() != 0}.
     *
