...
/**
 * Implementation of {@link TranslationAdvice} which represents what the dex
 * format will be able to represent.
 */
public final class DexTranslationAdvice
    ...
    /**
     * The minimum source width, in register units, for an invoke instruction
     * that requires its sources to be in order and contiguous.
     */
