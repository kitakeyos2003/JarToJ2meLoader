...
public class LocalItem implements Comparable<LocalItem> {
    ...
    /**
     * Compares two strings like String.compareTo(), excepts treats a null as
     * the least-possible string value.
     *
     * @return negative integer, zero, or positive integer in accordance with
