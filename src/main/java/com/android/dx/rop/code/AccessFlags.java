...
/**
 * Constants used as "access flags" in various places in classes, and related
 * utilities. Although, at the rop layer, flags are generally ignored, this is
 * the layer of communication, and as such, this package is where these
 * definitions belong. The flag definitions are identical to Java access flags,
 * but {@code ACC_SUPER} isn't used at all in translated code, and
 * {@code ACC_SYNCHRONIZED} is only used in a very limited way.
 */
public final class AccessFlags {
    ...
    /**
     * synchronized method; only valid in dex files for {@code native} methods
     */
    public static final int ACC_SYNCHRONIZED = 0x0020;

    /**
     * class with new-style {@code invokespecial} for superclass method access
     */
    ...
    /**
     * method with strict floating point ({@code strictfp}) behavior
     */
    ...
    /**
     * method was declared {@code synchronized}; has no effect on execution
     * (other than inspecting this flag, per se)
     */
    ...
    /**
     * Returns a human-oriented string representing the given access flags, as
     * defined on classes (not fields or methods).
     *
    ...
    /**
     * Returns a human-oriented string representing the given access flags, as
     * defined on fields (not classes or methods).
     *
     * @param flags the flags
     * @return {@code non-null;} human-oriented string
     */
    ...
    /**
     * Returns a human-oriented string representing the given access flags, as
     * defined on methods (not classes or fields).
     *
     * @param flags the flags
     * @return {@code non-null;} human-oriented string
     */
    ...
    /**
     * Returns whether the flag {@code ACC_PRIVATE} is on in the given flags.
     *
    ...
    /**
     * Returns whether the flag {@code ACC_STATIC} is on in the given flags.
     *
     * @param flags the flags to check
    ...
    /**
     * Returns whether the flag {@code ACC_SYNCHRONIZED} is on in the given
     * flags.
     *
     * @param flags the flags to check
    ...
    /**
     * Returns whether the flag {@code ACC_ABSTRACT} is on in the given flags.
     *
     * @param flags the flags to check
    ...
    /**
     * Returns whether the flag {@code ACC_NATIVE} is on in the given flags.
     *
     * @param flags the flags to check
    ...
    /**
     * Returns whether the flag {@code ACC_ANNOTATION} is on in the given flags.
     *
     * @param flags the flags to check
    ...
    /**
     * Helper to return a human-oriented string representing the given access
     * flags.
     *
