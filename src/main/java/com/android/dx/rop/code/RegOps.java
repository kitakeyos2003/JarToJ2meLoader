 ...
 *
 * <p>
 * <b>Note:</b> Opcode descriptions use a rough pseudocode. {@code r} is the
 * result register, {@code x} is the first argument, {@code y} is the second
 * argument, and {@code z} is the third argument. The expression which describes
...
public final class RegOps {
     ...
     * <b>Note:</b> This opcode should only ever be used in the first
     * instruction of a block, and such blocks must be the start of an exception
     * handler.
     */
    ...
    /**
     * {@code T: any numeric type; r,x,y: T :: r = x % y} (Java-style remainder)
     */
    ...
    /**
     * {@code T: any integral type; r,x: T; y: int :: r = x >> y} (signed
     * right-shift)
     */
    public static final int SHR = 24;

    /**
     * {@code T: any integral type; r,x: T; y: int :: r = x >>> y} (unsigned
     * right-shift)
     */
     ...
     * : (x > y) ? 1 : -1} (Java-style "cmpl" where a NaN is considered "less
     * than" all other values; also used for integral comparisons)
     */
    public static final int CMPL = 27;

    /**
     * {@code T: any floating point type; r: int; x,y: T :: r = (x == y) ? 0
     * : (x < y) ? -1 : 1} (Java-style "cmpg" where a NaN is considered "greater
     ...
     * r = (T) x} (numeric type conversion between the four "real" numeric
     * types)
     */
    ...
    /**
     * {@code T: any object type; x: Object :: (T) x} (can throw
    ...
    /**
     * {@code Tr, T0, T1...: any types; r: Tr; x: Object; m: instance method
     * spec; y0: T0; y1: T1 ... :: r = x.m(y0, y1, ...)} (call superclass
     * virtual method)
     */
    ...
    /**
     * {@code Tr, T0, T1...: any types; r: Tr; x: Object; m: instance method
     * spec; y0: T0; y1: T1 ... :: r = x.m(y0, y1, ...)} (call direct/special
     * method)
     */
    ...
    /**
     * {@code T0: any type; name: local variable name  :: mark(name,T0)} (mark
     * beginning or end of local variable name)
     */
     ...
     * <b>Note:</b> This opcode should only ever be used in the first
     * instruction of a block following an invoke-*.
     */
     ...
     * {@code T: Any type; r: T :: r = return_type}.
     * <b>Note:</b> This opcode should only ever be used in the first
     * instruction of a block following a non-invoke throwing insn
     */
