...
/**
 * Instruction which possibly throws. The {@code successors} list in the basic
 * block an instance of this class is inside corresponds in-order to the list of
 * exceptions handled by this instruction, with the no-exception case appended
 * as the final target.
 */
