...
public abstract class CstBaseMethodRef
    ...
    /**
     * Get whether this is a reference to a signature polymorphic method. This
     * means it is defined in {@code java.lang.invoke.MethodHandle} and is
     * either the {@code invoke} or the {@code invokeExact} method.
     *
     * @return {@code true} iff this is a reference to a signature polymorphic
     * method.
     */
