...
public final class CstFieldRef extends CstMemberRef {
    ...
    /**
     * Returns an instance of this class that represents the static field which
     * should hold the class corresponding to a given primitive type. For
     * example, if given {@link Type#INT}, this method returns an instance
     * corresponding to the field {@code java.lang.Integer.TYPE}.
     *
