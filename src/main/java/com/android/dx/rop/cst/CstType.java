...
public final class CstType extends TypedConstant {
    ...
    /**
     * {@code non-null;} instance corresponding to the type
    ...
    /**
     * Returns an instance of this class that represents the wrapper class
     * corresponding to a given primitive type. For example, if given
     * {@link Type#INT}, this method returns the class reference
    ...
    /**
     * Gets the underlying type (as opposed to the type corresponding to this
     * instance as a constant, which is always {@code Class}).
     *
    ...
    /**
     * Returns a human readable package name for this type, like "java.util". If
     * this is an array type, this returns the package name of the array's
