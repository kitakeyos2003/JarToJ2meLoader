...
public final class CstNat extends Constant {
     ...
     * {@code java.lang.Class}, which is useful when dealing with wrapped
     * primitives
     */
    ...
    /**
     * Gets the field type corresponding to this instance's descriptor. This
     * method is only valid to call if the descriptor in fact describes a field
     * (and not a method).
     *
    ...
    /**
     * Gets whether this instance has the name of a signature polymorphic
     * method.
     *
     * @return {@code true} iff the name suggest it could be signature
     * polymorphic method.
     */
