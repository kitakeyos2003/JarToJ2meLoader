...
public abstract class Constant
    ...
    /**
     * Returns {@code true} if this instance is a category-2 constant, meaning
     * it takes up two slots in the constant pool, or {@code false} if this
     * instance is category-1.
     *
    ...
    /**
     * Returns the human name for the particular type of constant this instance
     * is.
     *
    ...
    /**
     * Compare the values of this and another instance, which are guaranteed to
     * be of the same class. Subclasses must implement this.
     *
     * @param other {@code non-null;} the instance to compare to
     * @return {@code -1}, {@code 0}, or {@code 1}, as usual for a comparison
     */
