...
/**
 * Standard implementation of {@link ConstantPool}, which directly stores an
 * array of {@link Constant} objects and can be made immutable.
 */
public final class StdConstantPool
     ...
     *
     * @param size the size of the pool; this corresponds to the class file
